...
int* generate_revert(int* A, int SIZE){
	...
	cout << "If you want to enter numbers yourself, press (1) and press (2) to generate random numbers (press (3) to generate an array sorted in the opposite direction): ";
	int sel = 0;
	cin >> sel;
	switch(sel){
		case 1:
